...
replies_small <- replies %>% 
  sample_n(n) %>% 
  write_csv("../data/gephi/reply_sample_edges.csv")
```
...
mentions_small <- mentions %>%
  sample_n(n) %>% 
  write_csv("../data/gephi/mention_sample_edges.csv")
```
...
users_replies_small <- users %>%
  ...
  write_csv("../data/gephi/reply_sample_nodes.csv")

users_mentions_small <- users %>%
  filter(Id %in% unique(unlist(mentions_small))) %>%
  write_csv("../data/gephi/mention_sample_nodes.csv")
```
