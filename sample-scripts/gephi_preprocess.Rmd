...
In addition to the edges that connect users in the network (representing either replies or mentions), we may wish to retain some additional *node-level* information about the users themselves, such as where they live, their number of followers, and whether or not they are verified on Twitter.
